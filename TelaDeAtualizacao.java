        ...
        btnAtualizar.addActionListener(
            new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    String selected = (String) cbxId.getSelectedItem();
                    String nome = txtNome.getText();
                    String email = txtEmail.getText();
                    String senha = new String(txtSenha.getPassword());

                    lblNotificacoes.setText("Atualizar ID:" + selected + "Nome:" + "Email:" + email);
                    System.out.println("Atualizado:" + selected + ", Nome:" + nome+ ", Email:" + email);
                }
            }
        );
        ...
        btnCancelar.addActionListener(
            new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    ...
                    txtEmail.setText("");
                    txtSenha.setText("");
                    lblNotificacoes.setText("Limpar os campos de texto.");
            ...
            @Override
                public void itemStateChanged(ItemEvent event) {
                    if (event.getStateChange() == ItemEvent.SELECTED) {
                        ...
                        System.out.println("Selecionado ID: " );
